...
export default function Pagination({ page, totalPages, totalElements, includeArchived }: Props) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 text-sm text-muted-foreground">
      <span>
        {totalElements} {totalElements === 1 ? "promoção" : "promoções"} · Página {page + 1} de{" "}
        {totalPages || 1}
      </span>
